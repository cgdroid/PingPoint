...
import com.tmhnry.pingpoint.api.ModelLoader;
import com.tmhnry.pingpoint.api.TransferLearningModel;
import com.tmhnry.pingpoint.api.TransferLearningModel.LossConsumer;
...
public class TransferLearningModelWrapper implements Closeable {
    ...
    public Future<Void> deleteSamples(){
       return model.deleteSamples() ;
    }
